...
load_from = './work_dirs/KiTS21_lr0.01_epoch100_batch16_v2/iter_9181.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ...
    keep_results=True,
    output_dir='./work_dirs/KiTS21_lr0.01_epoch100_batch16_v2/format_results',
    type='IoUMetric')
test_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(keep_ratio=True, scale=(
...
train_cfg = dict(max_iters=9181, type='IterBasedTrainLoop', val_interval=1000)
...
work_dir = './work_dirs/KiTS21_lr0.01_epoch100_batch16_v2'
