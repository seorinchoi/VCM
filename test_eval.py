...
# Directory Settings
image_dir = "/content/VCMI/datasets/test-small/images/"
gt_dir = "/content/VCMI/datasets/test-small/masks"
pred_dir =  '/content/drive/MyDrive/work_dirs/batch32lr0.001/format_results/'
result_dir = "/content/drive/MyDrive/work_dirs/batch32lr0.001/results/"
resultimg_dir = "/content/drive/MyDrive/work_dirs/batch32lr0.001/results/img/"
...
def evaluation(xmin, ymin, xmax, ymax):
    ...
    for idx, (img_name, gt_name, pred_name) in enumerate(zip(image_files, gt_files, pred_files)):
        ...
        print(f"ETA: {int(eta // 60)} minutes, {int(eta % 60)} seconds remaining")
